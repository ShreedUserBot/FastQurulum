#'Ogurlayan Peyserdi'
#'Peysersen Bax Ogurlamaga Gelibsen!'
...
if __name__ == "__main__":
    ...
    SyperStringKey = "ShreedUserBot"
    GiperStringKey = "ShreedUserBot/"
    ...
    config['TELEGRAPH_SHORT_NAME'] = "shreeduserbot"
    config["TMP_DOWNLOAD_DIRECTORY"] = "./DOWNLOADS/"
